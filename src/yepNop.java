        ...
        panel.addKeyListener(new KeyAdapter() {//добавляем слушателя на панель
            public void keyReleased(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_SPACE) //если нажат пробел
                {
                    ...
                    int result1 = pane.showConfirmDialog(panel, "Кофе будете?", "Вопрос 1", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);//выводим 1 вопрос
                    int result2 = pane.showConfirmDialog(panel, "А булочку?", "Вопрос 2", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);//выводим 2 вопрос
                    String result;
                    if (result1 == 0 && result2 == 0) result = "Ваш заказ: кофе и булочка";
                    else if (result1 == 0 && result2 != 0) result = "Ваш заказ: кофе";
                    else if (result1 != 0 && result2 == 0) result = "Ваш заказ: булочка";
                    else result = "Ходите голодным";
