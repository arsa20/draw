...
public class DVD {
    public static void main(String[] args) throws IOException {
        ...
        frame.setTitle("Движущийся рандомно логотип");//заголовок формы
        ...
        BufferedImage previewImage = ImageIO.read(new URL("https://i.ebayimg.com/images/g/2tcAAOSwORthpIle/s-l1600.png"));//скачиваем картинку
